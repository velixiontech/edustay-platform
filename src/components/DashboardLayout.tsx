...
const navItems: Record<string, NavItem[]> = {
  ...
  surety: [
    { label: "Dashboard", href: "/surety", icon: <Home className="h-4 w-4" /> },
    { label: "Application", href: "/surety/application", icon: <ClipboardList className="h-4 w-4" /> },
    { label: "Contract", href: "/surety/contract", icon: <FileText className="h-4 w-4" /> },
  ],
};
...
const roleLabels: Record<string, string> = {
  ...
  surety: "Surety Portal",
};

interface DashboardLayoutProps { role: "admin" | "student" | "owner" | "finance" | "maintenance_role" | "surety"; children: ReactNode; }
