...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    id: "n4",
    type: "rent_reminder",
    title: "Rent Outstanding — Action Required",
    message: "Your rent for this month has not yet been received. Please make payment as soon as possible to avoid further action.",
    targetUserIds: ["s1"],
  ...
  },
  {
    id: "n5",
    type: "rent_reminder",
    title: "Surety Notice — Tenant Rent Outstanding",
    message: "The student you are surety for (Thabo Nkosi) has not paid this month's rent. As surety you are jointly liable. Please follow up.",
    targetUserIds: ["sur1"],
    timestamp: "2026-03-06T09:00:00",
    read: false,
  },
  {
    id: "n6",
    type: "general",
    title: "Surety Invitation",
    message: "You have been invited as surety for Thabo Nkosi following successful placement. Please review the application and sign the lease.",
    targetUserIds: ["sur1"],
